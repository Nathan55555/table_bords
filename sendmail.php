...
$mail->setFrom('Nathansroussi@gmail.com', 'Nathan Delegue');
...
while($i<count($eleve))
{
    $mail->addAddress($eleve[$i]['mail'], $eleve[$i]['nom']);
    $i = $i+1;
}
$mail->addAddress('nathansroussi@gmail.com', 'Nathan');
...
header('Location:mail.php?status=OK&par=$par');
